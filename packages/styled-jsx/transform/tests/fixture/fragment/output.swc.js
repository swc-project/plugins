...
export default () => (
  <>
    ...
    <>
      <h3 id="head" className={"jsx-6dd5f97e085c0297"}>
        Title...
      </h3>
    ...
    <_JSXStyle id={"6dd5f97e085c0297"}>
      {
        "p.jsx-6dd5f97e085c0297{color:#0ff}.foo.jsx-6dd5f97e085c0297{font-size:18px;color:#ff69b4}#head.jsx-6dd5f97e085c0297{text-decoration:underline}"
      }
    </_JSXStyle>
  </>
);
...
function Component2() {
  return (
    <div className={"jsx-678f41ca6d3b294b"}>
